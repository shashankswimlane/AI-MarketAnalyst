...
test("MessageList shows friendly label for a completed file creation", () => {
  const messages: Message[] = [
    {
      id: "1",
      role: "assistant",
      ...
      parts: [
        {
          ...
          toolInvocation: {
            ...
            toolName: "str_replace_editor",
            state: "result",
            result: "File created: /components/Button.jsx",
          },
        },
      ],
    },
...
test("MessageList shows in-progress label for a pending edit", () => {
  const messages: Message[] = [
    {
      id: "1",
      role: "assistant",
